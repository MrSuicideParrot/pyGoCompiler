...
_lr_productions = [
  ...
  ('expressionBo -> expressionBo AND expressionBo','expressionBo',3,'p_expressionBo_binop','plintax.py',166),
  ('expressionBo -> expressionBo OR expressionBo','expressionBo',3,'p_expressionBo_binop','plintax.py',167),
  ('expressionBo -> NOT expressionBo','expressionBo',2,'p_expressionBo_inverse','plintax.py',188),
  ('expressionBo -> TRUE','expressionBo',1,'p_expressionBo_int','plintax.py',194),
  ('expressionBo -> FALSE','expressionBo',1,'p_expressionBo_int','plintax.py',195),
  ('expressionBo -> LPAREN expressionBo RPAREN','expressionBo',3,'p_expressionBo_group','plintax.py',203),
]
